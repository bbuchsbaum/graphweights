...
rec_coarsen_impl <- function(W, T, phi_ = NULL, deterministic_first_edge = FALSE, verbose = FALSE, seed = NA_integer_) {
    .Call('_neighborweights_rec_coarsen_impl', PACKAGE = 'neighborweights', W, T, phi_, deterministic_first_edge, verbose, seed)
}
